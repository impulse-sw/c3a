...
impl Secret {
  ...
  pub fn to_encoded(&self) -> Self {
    match self {
      Secret::Raw(s) => Secret::Encoded(base32::encode(Alphabet::RFC4648 { padding: false }, s)),
...
mod tests {
  ...
  const BYTES: [u8; 23] = [
    0x70, 0x6c, 0x61, 0x69, 0x6e, 0x2d, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x2d, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74,
    0x2d, 0x31, 0x32, 0x33,
  ];
