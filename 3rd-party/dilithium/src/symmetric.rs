...
pub fn stream128_squeezeblocks(out: &mut [u8], outblocks: u64, state: &mut Stream128State)
{
  #[cfg(not(feature = "aes"))]
...
pub fn stream256_squeezeblocks(out: &mut [u8], outblocks: u64, state: &mut Stream256State)
{
  #[cfg(not(feature = "aes"))]
...
#[cfg(feature = "aes")]
pub fn dilithium_aes256ctr_init(state: &mut Aes256ctrCtx, key: &[u8], nonce: u16)
{
...
#[cfg(not(feature = "aes"))]
pub fn dilithium_shake128_stream_init(state: &mut KeccakState, seed: &[u8], nonce: u16)
{
...
#[cfg(not(feature = "aes"))]
pub fn dilithium_shake256_stream_init(state: &mut KeccakState, seed: &[u8], nonce: u16)
{
  let t = [nonce as u8, (nonce >> 8) as u8];
  state.init();
