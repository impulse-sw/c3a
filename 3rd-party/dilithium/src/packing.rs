use crate::{SignError, params::*, poly::*, polyvec::*};
...
pub fn pack_sk(sk: &mut [u8], rho: &[u8], tr: &[u8], key: &[u8], t0: &Polyveck, s1: &Polyvecl, s2: &Polyveck)
{
  let mut idx = 0usize;
...
pub fn unpack_sig(c: &mut [u8], z: &mut Polyvecl, h: &mut Polyveck, sig: &[u8]) -> Result<(), SignError>
{
  let mut idx = 0usize;
